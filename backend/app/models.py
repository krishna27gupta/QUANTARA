...
from sqlalchemy import String, Decimal, ForeignKey, DateTime, Boolean, Text
...
class Prediction(Base):
    ...
    confidence_score: Mapped[Decimal] = mapped_column(Decimal(5, 2), nullable=False) # e.g. 0.00 to 100.00
...
class Recommendation(Base):
    ...
    id: Mapped[UUID] = mapped_column(primary_key=True, default=uuid4)
    stock_id: Mapped[UUID] = mapped_column(ForeignKey("stocks.id", ondelete="CASCADE"), nullable=False)
    recommendation_type: Mapped[str] = mapped_column(String(10), nullable=False) # BUY, SELL, HOLD
...
class Subscription(Base):
    ...
    status: Mapped[str] = mapped_column(String(50), default="active") # active, inactive, trialing
